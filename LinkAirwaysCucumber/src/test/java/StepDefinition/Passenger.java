...
public class Passenger {
	...
	public void i_want_to_write_child_passenger_details() {
		...
		try {
			page.childPassenger(dataDriven.getStringData("Passenger", 10, 1),
					dataDriven.getStringData("Passenger", 11, 1), dataDriven.getStringData("Passenger", 12, 1),
					dataDriven.getStringData("Passenger", 13, 1), dataDriven.getStringData("Passenger", 14, 1),
					dataDriven.getStringData("Passenger", 15, 1), dataDriven.getStringData("Passenger", 16, 1));
		} catch (Exception e) {
			Helper.getscreenshot();
		}
	}
